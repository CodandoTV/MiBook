...
mixin _$BookDetailsState {
 ...
 bool get isLoading; String? get errorMessage; BookDetailsUI? get bookDetails;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookDetailsState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.bookDetails, bookDetails) || other.bookDetails == bookDetails));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,errorMessage,bookDetails);

@override
String toString() {
  return 'BookDetailsState(isLoading: $isLoading, errorMessage: $errorMessage, bookDetails: $bookDetails)';
}
...
@useResult
$Res call({
 String? errorMessage, BookDetailsUI? bookDetails, bool isLoading
});
...
/// Create a copy of BookDetailsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? errorMessage = freezed,Object? bookDetails = freezed,Object? isLoading = null,}) {
